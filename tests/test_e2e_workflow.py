"""
End-to-end test: full Hx policy workflow (16 steps).

Creates a policy, uploads data, configures triangles, and exports results.
All steps run sequentially in a single test because each depends on the previous.
"""
...
POLICY_NAME = "Upload_Output_v01_Everest"
UPLOAD_FILENAME = "Upload_Output_v01_Everest.xlsx"
...
def test_full_hx_workflow(browser_context):
    ...
    try:
        ...
        policy_list.set_model_version("2025-v4")
        ...
        # ── Steps 8-16: configure and export ──
        ...
        logger.info("All 16 steps completed successfully")
